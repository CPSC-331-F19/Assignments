...
\author{Guransh Mangat, 30061719 \\ Daniel Contreras, 10080311 \\ Steven \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\  }
\date{}
...
\begin{problem}{5} 
    ...
    \hspace*{-6mm}then $T_{smacG}(n) \geq \left(\frac{3}{2}\right)^n$ for every non-negative integer $n$ and therefore
...
\hspace*{-6mm}\textit{Basis}. If $n=0$, then $T_{smacG}\left(n\right) = T_{smacG}\left(0\right) = 2$, and 
\begin{flalign*}
...
\hspace*{-6mm}\textit{Inductive Step}. Let $k \geq 4$ be an integer. It is necessary and sufficient
...
\hspace*{-6mm}thus establishing the inductive claim, as needed. Therefore, by principle of induction 
